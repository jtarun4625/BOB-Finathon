...
app_id = "1749115788727832"
app_secret = "5143e54e666dd8fa0c8102bb29497a4d"  # DO NOT SHARE WITH ANYONE!
group_id = "1772185249673634" #group we want to scrape
...
def processFacebookPageFeedStatus(status):
    ...
    return (status_id, person_id, status_message, status_author, link_name, status_type,
...
def scrapeFacebookPageFeedStatus(group_id, access_token, since_date, until_date):
    with open('{}_facebook_statuses.csv'.format(group_id), 'w') as file:
        w = csv.writer(file)
        w.writerow(["status_id", "person id", "status_message", "status_author", "link_name",
                    "profile_id","status_type", "status_link", "status_published",
